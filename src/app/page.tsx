  ...
  return (
    <>
    {
      ...
      <header className={`hidden ${cross?"hidden":"sm:flex sm:justify-between sm:items-center"} shadow-md z-10 mb-[0.35px]  w-full h-9 bg-[#f0f0f0]  p-2 `} >
        <div>
          <Image className=" cursor-pointer" src='/images/logo.png' width={30} height={30} alt="logo" />
        </div>
        <div className="flex flex-row-reverse gap-3">
          ...
          <div className="flex">
            <Image className=" cursor-pointer" src='images/left.svg' width={20} height={20} alt="multiply" />
            <Image className=" cursor-pointer" src='images/right.svg' width={20} height={20} alt="multiply" />
          </div>
        </div>
        <div className="flex flex-row-reverse gap-2 items-center">
          <Image className=" cursor-pointer" onClick={()=>setCross(true)} src='images/multiply.svg' width={20} height={20} alt="multiply" />
          <Image className=" cursor-pointer" src='images/square.svg' width={17} height={17} alt="square" />
          <Image className=" cursor-pointer" src='images/minus.svg' width={20} height={20} alt="minus" />
          <div className="border border-[#828282] rounded-full p-1 relative">
            <Image className=" cursor-pointer" src='images/user.svg' width={17} height={17} alt="user" />
            <Image className=" cursor-pointer absolute bottom-[-2px] left-4 border-white rounded-full border-2" src='images/correct.svg' width={15} height={15} alt="user" />
          </div>
      ...
      <main className="w-full flex">
        <div className={`hidden ${cross?"hidden":"sm:flex"} w-12 bg-[#f0f0f0] text-[#828282] text-[0.5rem] text-center flex flex-col gap-3`}>
          ...
          <div className="cursor-pointer text-center text-[#5E60C2] border-s-2 border-[#5E60c2] ms-[2px]">
        ...
        <div className="w-full">
          <div className="hidden sm:flex justify-between px-3  border-b border-opacity-30 border-[#828282]">
            <div className="flex gap-3 text-sm">
              ...
              <Image className="cursor-pointer" src='/images/blacklogo.png' width={25} height={25} alt="bell" />
                <p className=" font-extrabold">Van Arsdel</p>
              </div>
              <p className=" cursor-pointer py-2 border-b-4 rounded-sm border-blue-400">Home</p>
              <p className=" cursor-pointer py-2">Timeline</p>
              <p className=" cursor-pointer py-2">Chat</p>
              <p className=" cursor-pointer py-2">Assigned To you</p>
            </div>
            <div className="flex gap-3">
              <Image className="cursor-pointer" src='images/upload.svg' width={17} height={17} alt="dot" />
              <Image className="cursor-pointer" src='images/dot.svg' width={17} height={17} alt="dot" />
            </div>

          </div>
          <div className="hidden sm:flex">
            <div className="flex justify-between p-1 border-b w-full">
              ...
              <div className="flex gap-4 ps-4 pe-6 ">
                <div className="flex gap-2">
                  <Image className=" cursor-pointer" src='images/circle.svg' width={20} height={20} alt="multiply" />
                  <p>Text</p>
                </div>
                <div className="flex gap-2">
                  <Image className=" cursor-pointer" src='images/circle.svg' width={20} height={20} alt="multiply" />
          ...
          <div className="flex h-[80%]">
            <div className="w-1/5 border-e hidden sm:block">
              <div className="ms-2 flex items-center text-[#828282]" onClick={()=>setGroup(!group)}>
                ...
                {
                  group ? 
                  <Image className=" cursor-pointer" src='/images/down.svg' width={30} height={30} alt="search" />
                  :
                  <Image className=" cursor-pointer" src='/images/up.svg' width={30} height={30} alt="search" />
              ...
              </div>
              {
                ...
                <div className=" ms-6 text-[#828282]">
                  <div className="flex items-center my-2" onClick={()=>setOption1(!option1)}>
                    ...
                    {
                      option1 ? 
                      <Image className=" cursor-pointer" src='/images/down.svg' width={25} height={25} alt="down" />
                      :
                      <Image className=" cursor-pointer" src='/images/up.svg' width={25} height={25} alt="up" />
                    }
                  </div>
                  {
                   option1 ? 
